...
"C:\MinGW\bin\g++" -std=c++14 -static-libgcc -static-libstdc++ -Wall -pedantic -O3 *.o -L%libdir% -lOpenGL32 -lSDL2 -lSDL2main -lmdl "%scriptdir%\res\exe\topaz_test.res" -o "topaz-test.exe"
