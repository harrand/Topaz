...
macro(export_shader_header)
	...
	add_custom_command(
		OUTPUT ${shader_header_target_name}
		...
		VERBATIM)
	set_source_files_properties(${EXPORT_SHADER_HEADER_FILE_NAME} ${shader_header_target_name} PROPERTIES GENERATED TRUE)
	target_sources(${ADD_SHADER_TARGET} PRIVATE ${shader_header_target_name})
	# Finally, create a target representing the generated header and make the target dependent on it so it can include it!
	set(shader_header_library ${shader_header_target_name}_target)
