...
int main()
{
    tz::initialise({"tz_mesh_test", tz::EngineInfo::Version{1, 0, 0}, tz::info()}, tz::ApplicationType::HiddenWindowApplication);
    {
        tz::gl::Mesh mesh;
        mesh.vertices =
        {
        ...
        tz_assert(a == b && b == expected_vertices_size, "Unexpected MeshInput dimensions");
    }
    tz::terminate();
}