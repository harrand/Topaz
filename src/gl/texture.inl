namespace tz::gl
{
	...
	void Texture::set_data(const tz::gl::Image<PixelT>& image)
	{
		using ComponentType = PixelT::ComponentType;
		constexpr GLint internal_format = tz::gl::pixel::parse_internal_format<PixelT>();
		constexpr GLenum format = tz::gl::pixel::parse_format<PixelT>();
	...
	template<PixelType PixelT>
	tz::gl::Image<PixelT> Texture::get_data() const
	{
		topaz_assert(this->descriptor.has_value(), "tz::gl::Texture::get_data<Pixel>(): Cannot get data because we never detected an invocation of set_data!");
		using ComponentType = PixelT::ComponentType;
		constexpr GLint internal_format = tz::gl::pixel::parse_internal_format<PixelT>();
		constexpr GLenum format = tz::gl::pixel::parse_format<PixelT>();
		constexpr GLenum type = tz::gl::pixel::parse_component_type<ComponentType>();
		...
		tz::gl::Image<PixelT> img{expected_descriptor.width, expected_descriptor.height};
