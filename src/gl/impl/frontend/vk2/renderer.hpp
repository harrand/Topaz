...
namespace tz::gl
{
	...
	public:
		 ...
		 */
		CommandProcessor(vk2::LogicalDevice& ldev, std::size_t frame_in_flight_count, OutputTarget output_target, std::span<vk2::Framebuffer> output_framebuffers, bool is_compute, bool instant_compute_enabled);
		/**
