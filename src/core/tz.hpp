 ...
 * 
 * Source location: Topaz/src/algo <br>
 * Namespace: `tz::algo`
 * <hr>
 ...
 * 
 * Source location: Topaz/src/input <br>
 * Namespace: `tz::input`
 * <hr>
