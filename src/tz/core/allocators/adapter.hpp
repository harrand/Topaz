...
namespace tz
{
	...
	public:
		...
		T* allocate(std::size_t n)
		{
			...
			hdk::assert(blk != nullblk, "AllocatorAdapter -- The underlying topaz allocator returned a null-block. Memory allocation failed. The standard library allocator is going to crash.");
