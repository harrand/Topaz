...
{
	return *dynamic_cast<const Object3D*>(this) == *dynamic_cast<const Object3D*>(&rhs) && *dynamic_cast<const Entity*>(this) == *dynamic_cast<const Entity*>(&rhs);
}