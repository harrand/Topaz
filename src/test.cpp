...
void init()
{
	...
	Panel gui_panel(0.0f, 0.0f, wnd.getWidth(), wnd.getHeight(), Vector4F(0.4f, 0.4f, 0.4f, 1.0f), engine.getDefaultGuiShader());
	...
	Button test_button(0.0f, 2 * text.getHeight(), Vector4F(1, 1, 1, 1), Vector4F(0.2, 0.2, 0.2, 1.0), Vector3F(0, 0, 0), example_font, "Hide/Show", engine.getDefaultGuiShader(), mc.getMouseListenerR());
